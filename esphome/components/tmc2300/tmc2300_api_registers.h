...
#define SG_RESULT_MASK           0x000003FF
#define SG_RESULT_SHIFT          0
#define SG_RESULT_FIELD          ((RegisterField) {SG_RESULT_MASK, SG_RESULT_SHIFT, SG_RESULT, false})
