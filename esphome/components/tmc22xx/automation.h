...
template<typename... Ts> class ConfigureAction : public Action<Ts...>, public Parented<TMC22XXComponent> {
 public:
...
template<typename... Ts> class ActivationAction : public Action<Ts...>, public Parented<TMC22XXComponent> {
...
template<typename... Ts> class CurrentsAction : public Action<Ts...>, public Parented<TMC22XXComponent> {
 public:
...
template<typename... Ts> class StallGuardAction : public Action<Ts...>, public Parented<TMC22XXComponent> {
 public:
...
template<typename... Ts> class CoolConfAction : public Action<Ts...>, public Parented<TMC22XXComponent> {
 public:
...
template<typename... Ts> class ChopConfAction : public Action<Ts...>, public Parented<TMC22XXComponent> {
 public:
...
template<typename... Ts> class PWMConfAction : public Action<Ts...>, public Parented<TMC22XXComponent> {
 public:
...
template<typename... Ts> class SyncAction : public Action<Ts...>, public Parented<TMC22XXComponent> {
 public:
  TEMPLATABLE_VALUE(std::vector<TMC22XXComponent *>, drivers);

  void set_drivers(const std::vector<TMC22XXComponent *> &drivers) { drivers_ = drivers; }
  ...
  void play(Ts... x) override {
    ...
    for (TMC22XXComponent *driver : this->drivers_.value()) {
...
class OnDriverStatusTrigger : public Trigger<DriverStatusEvent> {
 public:
  explicit OnDriverStatusTrigger(TMC22XXComponent *parent) {
...
class OnStallTrigger : public Trigger<> {
 public:
  explicit OnStallTrigger(TMC22XXComponent *parent) {
