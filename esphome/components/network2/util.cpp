...
#ifdef USE_PPPOS
  if (ppp::global_pppos_component != nullptr)
    return ppp::global_pppos_component->is_connected();
#endif
...
#ifdef USE_PPPOS
  if (ppp::global_pppos_component != nullptr)
    return ppp::global_pppos_component->get_ip_address();
#endif
...
#ifdef USE_PPPOS
  if (ppp::global_pppos_component != nullptr)
    return ppp::global_pppos_component->get_use_address();
#endif
  return "";
}
