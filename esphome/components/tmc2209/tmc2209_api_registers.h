...
#define I_SCALE_ANALOG_FIELD          ((esphome::tmc2209::RegisterField) { I_SCALE_ANALOG_MASK, I_SCALE_ANALOG_SHIFT, GCONF, false })
...
#define INTERNAL_RSENSE_FIELD         ((esphome::tmc2209::RegisterField) { INTERNAL_RSENSE_MASK, INTERNAL_RSENSE_SHIFT, GCONF, false })
...
#define EN_SPREADCYCLE_FIELD          ((esphome::tmc2209::RegisterField) { EN_SPREADCYCLE_MASK, EN_SPREADCYCLE_SHIFT, GCONF, false })
...
#define MSTEP_REG_SELECT_FIELD        ((esphome::tmc2209::RegisterField) { MSTEP_REG_SELECT_MASK, MSTEP_REG_SELECT_SHIFT, GCONF, false })
...
#define MULTISTEP_FILT_FIELD          ((esphome::tmc2209::RegisterField) { MULTISTEP_FILT_MASK, MULTISTEP_FILT_SHIFT, GCONF, false })
...
#define OTP0_BYTE_0_READ_DATA_FIELD   ((esphome::tmc2209::RegisterField) { OTP0_BYTE_0_READ_DATA_MASK, OTP0_BYTE_0_READ_DATA_SHIFT, OTP_READ, false })
...
#define OTP1_BYTE_1_READ_DATA_FIELD   ((esphome::tmc2209::RegisterField) { OTP1_BYTE_1_READ_DATA_MASK, OTP1_BYTE_1_READ_DATA_SHIFT, OTP_READ, false })
...
#define OTP2_BYTE_2_READ_DATA_FIELD   ((esphome::tmc2209::RegisterField) { OTP2_BYTE_2_READ_DATA_MASK, OTP2_BYTE_2_READ_DATA_SHIFT, OTP_READ, false })
...
#define PWM_OFS_FIELD                 ((esphome::tmc2209::RegisterField) { PWM_OFS_MASK, PWM_OFS_SHIFT, PWM_CONF, false })
...
#define PWM_GRAD_FIELD                ((esphome::tmc2209::RegisterField) { PWM_GRAD_MASK, PWM_GRAD_SHIFT, PWM_CONF, false })
...
#define PWM_FREQ_FIELD                ((esphome::tmc2209::RegisterField) { PWM_FREQ_MASK, PWM_FREQ_SHIFT, PWM_CONF, false })
#define PWM_AUTOSCALE_MASK            0x040000 // PWM_CONF//
#define PWM_AUTOSCALE_SHIFT           18 // min.: 0, max.: 1, default: 0
#define PWM_AUTOSCALE_FIELD           ((esphome::tmc2209::RegisterField) { PWM_AUTOSCALE_MASK, PWM_AUTOSCALE_SHIFT, PWM_CONF, false })
#define PWM_AUTOGRAD_MASK             0x080000 // PWM_CONF//
#define PWM_AUTOGRAD_SHIFT            19 // min.: 0, max.: 1, default: 0
#define PWM_AUTOGRAD_FIELD            ((esphome::tmc2209::RegisterField) { PWM_AUTOGRAD_MASK, PWM_AUTOGRAD_SHIFT, PWM_CONF, false })
...
#define FREEWHEEL_FIELD               ((esphome::tmc2209::RegisterField) { FREEWHEEL_MASK, FREEWHEEL_SHIFT, PWM_CONF, false })
...
#define PWM_REG_FIELD                 ((esphome::tmc2209::RegisterField) { PWM_REG_MASK, PWM_REG_SHIFT, PWM_CONF, false })
...
#define PWM_LIM_FIELD                 ((esphome::tmc2209::RegisterField) { PWM_LIM_MASK, PWM_LIM_SHIFT, PWM_CONF, false })
...
#define PWM_SCALE_SUM_FIELD           ((esphome::tmc2209::RegisterField) { PWM_SCALE_SUM_MASK, PWM_SCALE_SUM_SHIFT, PWM_SCALE, false })
...
#define PWM_SCALE_AUTO_FIELD          ((esphome::tmc2209::RegisterField) { PWM_SCALE_AUTO_MASK, PWM_SCALE_AUTO_SHIFT, PWM_SCALE, true })
