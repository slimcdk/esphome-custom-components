...
#include "events.h"
#include "tmc2300_config_dumps.h"
...
class TMC2300Component : public TMC2300API, public Component {
 public:
  TMC2300Component(uint8_t address, uint32_t clk_frequency, bool internal_rsense, float rsense, bool analog_scale)
      : TMC2300API(address),
