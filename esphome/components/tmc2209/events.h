...
enum DriverStatusEvent {
  ...
  TEMPERATURE_BELOW_120C = 15,
  TEMPERATURE_ABOVE_120C = 16,
  TEMPERATURE_BELOW_143C = 17,
  TEMPERATURE_ABOVE_143C = 18,
  TEMPERATURE_BELOW_150C = 19,
  TEMPERATURE_ABOVE_150C = 20,
  TEMPERATURE_BELOW_157C = 21,
  TEMPERATURE_ABOVE_157C = 22,
