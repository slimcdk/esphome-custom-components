...
#if defined(ENABLE_DRIVER_ALERT_EVENTS)
void TMC2300Component::check_driver_status_() {
  /*
...
uint16_t TMC2300Component::get_microsteps() {
...
void TMC2300Component::set_target(int32_t steps) {
  if (this->en_pin_ != nullptr) {
    this->enable(true);
  }
...
void TMC2300Component::dump_config() {
