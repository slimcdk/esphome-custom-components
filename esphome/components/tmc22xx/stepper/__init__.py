...
CONFIG_SCHEMA = cv.All(
    _build_typed_schema(
        tmc2202=TMC22XXStepper,  # TMC2202Stepper,
        tmc2208=TMC22XXStepper,  # TMC2208Stepper,
        tmc2209=TMC22XXStepper,  # TMC2209Stepper,
        tmc2224=TMC22XXStepper,  # TMC2224Stepper,
        tmc2225=TMC22XXStepper,  # TMC2225Stepper,
        tmc2226=TMC22XXStepper,  # TMC2226Stepper,
