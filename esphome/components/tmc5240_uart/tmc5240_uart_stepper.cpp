#include "tmc5240_uart_stepper.h"
...
int32_t TMC5240UARTStepper::read_register(uint8_t address) {
...
void TMC5240UARTStepper::write_register(uint8_t address, int32_t value) {
